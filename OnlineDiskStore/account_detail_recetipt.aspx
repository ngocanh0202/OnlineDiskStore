...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="display: flex;flex-direction: column; align-items: stretch;height: auto;width: auto;">
        <asp:GridView ID="GridView1" Width="100%" runat="server" CssClass="gridview_detail" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
    ...
    <div class="detail_receipt">
        ...
        <asp:Label ID="Label4" runat="server" Text=""></asp:Label><span>VND</span>
    </div>
</asp:Content>

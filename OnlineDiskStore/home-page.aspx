...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="goods">
        <div class="header_text">
            <div class="text" style="width: 191px;">Hàng mới phát hành</div>
            <div class="line_header" style="width: 778px;"></div>
        </div>
    ...
    <div class="goods">
        ...
        <div class="content_goods">
            <asp:DataList ID="DataList6" runat="server" RepeatColumns="3" Width="960px">
                <ItemTemplate>
                    <div class="item_disk">
                        <div class="image_of_disk">
                            <div class="image_of_disk_1">
